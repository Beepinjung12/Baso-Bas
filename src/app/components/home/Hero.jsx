...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-sky600 via-sky400 to-sky200 px-8 py-17.5 pb-20 text-center max-md:px-4 max-md:py-12">
      <div className="absolute -right-20 -top-16 h-85 w-85 rounded-full bg-white/10" />
      <div className="absolute -bottom-20 -left-16 h-65 w-65 rounded-full bg-white/10" />
      ...
      <div className="relative z-10 mx-auto flex max-w-155 items-center gap-2 rounded-full bg-white px-5 py-1.5 shadow-[0_4px_24px_rgba(3,105,161,0.18)] max-md:flex-col max-md:rounded-2xl max-md:p-3">
